...
\begin{figure}[h]
    \centering\includegraphics[width=.8\textwidth]{figures/sam/untuned short med long.png}
    \caption{BiomedCLIP's out-of-the-box performance in generating saliency maps for the cilia dataset. The \textit{GT Mask} represents the ground-truth annotated mask for the sasmple image. The bright spots on the saliency maps represent thresholded to only include values over 0.5 }
