...
In the biomedical field, where labeled data is often scarce and costly to obtain, several solutions have been proposed to augment and utilize available data effectively. These include semi-supervised learning \cite{YAKIMOVICH2021100383}, \cite{van2020survey}, which utilizes both labeled and unlabeled data to enhance learning accuracy by leveraging the data’s underlying distribution. Active learning \cite{settles2009active} focuses on selectively querying the most informative data points for expert labeling, optimizing the training process by using the most valuable examples. Data augmentation techniques \cite{10.3389/fcvm.2020.00105}, \cite{Krois2021}, \cite{10.1148/ryai.2020190195}, \cite{Sandfort2019}, \cite{YAKIMOVICH2021100383}, \cite{van2001art}, \cite{krizhevsky2012imagenet}, \cite{ronneberger2015u}, such as image transformations and synthetic data generation through Generative Adversarial Networks \cite{goodfellow2014generative}, \cite{yi2019generative}, increase the diversity and volume of training data, enhancing model robustness and reducing overfitting. Transfer learning \cite{YAKIMOVICH2021100383}, \cite{Sanford2020-yg}, \cite{NEURIPS2019_eb1e7832}, \cite{hutchinson2017overcoming} transfers knowledge from one task to another, minimizing the need for extensive labeled data in new tasks. Self-supervised learning \cite{kim2019self}, \cite{kolesnikov2019revisiting}, \cite{mahendran2019cross} creates its labels by defining a pretext task, like predicting the position of a randomly cropped image patch, aiding in the learning of useful data representations. Additionally, few-shot, one-shot, and zero-shot learning techniques \cite{li2006one}, \cite{miller2000learning} are designed to operate with minimal or no labeled examples, relying on generalization capabilities or metadata for making predictions about unseen classes.
